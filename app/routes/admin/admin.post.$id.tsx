...
export default function AdminPostDetail() {
  ...
  return (
    <div
      className={`min-h-screen p-6 ${theme === "dark" ? "bg-gray-900" : "bg-gray-100"
        }`}
    >
      <div className="max-w-3xl mx-auto">
        ...
        <motion.div
          ...
          className={`rounded-lg p-6 shadow overflow-clip ${theme === "dark"
        ...
        >
          ...
          <div
            className={`prose-sm max-w-none flex-wrap break-words ${theme === "dark" ? "text-gray-100" : "text-gray-900 prose-light"
              }`}
        ...
        <div className="mt-8">
          <Link
            to="/admin/home"
            className={`inline-block px-4 py-2 rounded-md font-medium mt-4 ${theme === "dark"
