      ...
      <div className="max-w-7xl mx-auto ">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          >
            ...
            />
            <h1
              className={`text-3xl lg:text-4xl font-bold p-6 bg-gradient-to-r ${theme === "dark"
            ...
            <p
              className={`text-sm/8 text-justify  leading-relaxed   lg:px-12 px-6 ${theme === "dark" ? "text-gray-300" : "text-gray-600"
                }`}
            >
              {bio}
            </p>
            ...
            <div className="space-y-4 max-h-96 overflow-y-auto pr-2 custom-scrollbar">
              {experiences?.slice(0, 4).map((exp, index) => (
                <motion.div
                  ...
                  className={`relative p-4 rounded-lg transition-all duration-300 ${theme === "dark"
                ...
                >
                  ...
                  <p
                    className={`text-sm mb-2 ${theme === "dark" ? "text-blue-400" : "text-blue-600"
                      }`}
                  >
                    {exp.period}
                  </p>
                ...
                <div className="space-y-3">
                  {currentWorks.slice(0, 2).map((work, index) => (
                    <motion.div
                      ...
                      className={`p-4 rounded-2xl transition-all duration-300 ${theme === "dark"
                    ...
                    >
                      <h3
                        className={`font-semibold text-base mb-2 ${theme === "dark"
                            ? "text-emerald-300"
                            : "text-emerald-700"
                          }`}
                      >
          ...
          >
            {skills && (
              <div
                className={`rounded-2xl p-6 shadow-lg border ${theme === "dark"
                        ...
                        >
                          <span
                            className={`${isLongSkill
                              ...
                              } text-center cursor-pointer transition-all duration-300 ${theme === "dark"
                                ? "bg-gradient-to-r from-gray-700 to-gray-600 text-gray-100 hover:from-gray-600 hover:to-gray-500"
                                : "bg-gradient-to-r from-gray-100 to-gray-200 text-gray-800 hover:from-gray-200 hover:to-gray-300"
                              } hover:shadow-md hover:-translate-y-0.5 ${isLongSkill ? "w-full" : ""
                              }`}
                          >
                            {skillText}
                          </span>
