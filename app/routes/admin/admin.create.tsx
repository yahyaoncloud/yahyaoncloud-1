...
export default function BlogPostCreatePage() {
  ...
  return (
    <div
      className={`min-h-screen p-6 transition-colors duration-300 ${theme === "dark" ? "bg-gray-900" : "bg-gray-100"
        }`}
    >
      ...
      >
        <div
          className={`rounded-lg shadow-xl p-8 transition-all duration-300 ${theme === "dark"
          ...
          <Form method="post" className="space-y-6">
            ...
            >
              ...
              <input
                ...
                required
                className={`w-full px-4 py-2 rounded-md border focus:outline-none focus:ring-2 focus:ring-blue-500 transition-all ${theme === "dark"
            ...
            >
              ...
              <textarea
                ...
                className={`w-full px-4 py-2 rounded-md border focus:outline-none focus:ring-2 focus:ring-blue-500 resize-y transition-all ${theme === "dark"
                    ? "bg-gray-700 border-gray-600 text-white"
                    : "bg-white border-gray-300 text-gray-900"
                  }`}
