      ...
      <Form method="post" className="space-y-4">
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <div className="space-y-1">
            ...
            <input
              ...
              name="title"
              required
              placeholder="e.g. Multi-Region Cloud GitOps Platform"
          ...
          <div className="space-y-1">
            ...
            <input
              type="text"
              name="slug"
              placeholder="multi-region-cloud-gitops"
        ...
        <div className="space-y-1">
          ...
          <textarea
            name="summary"
            rows={2}
            placeholder="1-2 sentences summarizing the engineering scope and impact..."
        ...
        <div className="space-y-1">
          ...
          <input
            type="text"
            name="techStack"
            placeholder="AWS EKS, Terraform, ArgoCD, Helm, Prometheus"
            className="w-full px-3 py-2 rounded-lg border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-900 text-sm font-mono focus:outline-none focus:border-zinc-400"
          />
        </div>
        ...
        <div className="space-y-1">
          ...
          <textarea
            name="content"
            rows={14}
            placeholder="# System Architecture&#10;&#10;Explain the problem, design choices, and results...&#10;&#10;```mermaid&#10;graph TD&#10;  A[Client] --> B[Load Balancer]&#10;```"
