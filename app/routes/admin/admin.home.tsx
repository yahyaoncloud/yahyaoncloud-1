...
const CategoryFilterSection = ({
  ...
  return (
    <section className="max-w-7xl mx-auto px-4 py-8">
      ...
      <AnimatePresence>
        <motion.div
          className={`flex-wrap gap-3 items-center justify-center md:flex ${showFilters ? "flex" : "hidden"
            } md:!flex`}
          initial="hidden"
          animate="visible"
          exit="hidden"
        >
          <motion.button
            ...
            className={`px-6 py-3 text-sm font-semibold rounded-full border-2 transition-all duration-200 ${selectedCategory === null
          ...
          {categories.map((cat, index) => (
            <motion.button
              ...
              className={`px-6 py-3 text-sm font-semibold rounded-full border-2 transition-all duration-200 ${selectedCategory === cat.name
                  ? "bg-blue-600 text-white border-blue-600 dark:bg-blue-700 dark:border-blue-500 shadow-lg"
                  : "bg-white text-gray-700 border-gray-300 hover:bg-blue-50 hover:border-blue-300 dark:bg-gray-800 dark:text-gray-100 dark:border-gray-600 dark:hover:bg-gray-700"
                }`}
            >
...
export default function Homepage() {
  ...
  return (
    <div
      className={`min-h-screen transition-colors duration-300 pb-8 ${theme === "dark" ? "bg-gray-950" : "bg-gray-50"
        }`}
    >
