...
export default function BlogIndex() {
  ...
  return (
    <div className="space-y-8 text-[13.5px] sm:text-[14px] leading-[1.75] tracking-[-0.011em] text-zinc-700 dark:text-zinc-300">
      ...
      <div className="space-y-3">
        {posts.map((post: BlogPost) => (
          <div key={post.slug} className="group">
            ...
            >
              <span className="font-normal text-zinc-800 dark:text-zinc-200 group-hover:underline decoration-zinc-300 dark:decoration-zinc-700 underline-offset-4 shrink-0">
                {post.title}
              </span>
      ...
      {/* Subscription Note */}
      <div className="pt-6 text-xs text-zinc-400 dark:text-zinc-500 flex items-center gap-1.5">
