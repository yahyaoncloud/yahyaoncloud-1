          ...
          <div className="flex flex-wrap items-center gap-2.5 pt-2 text-xs sm:text-sm font-mono">
            ...
            {paper.doi && (
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-md font-medium bg-zinc-100/60 dark:bg-zinc-900/60 text-zinc-700 dark:text-zinc-300 border border-zinc-200/80 dark:border-zinc-800/80 hover:bg-indigo-600 hover:text-white dark:hover:bg-indigo-600 dark:hover:text-white shadow-2xs active:scale-[0.98] transition-all"
              >
                <LuLink size={14} />
