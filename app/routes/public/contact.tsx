        ...
        <form className="space-y-4" onSubmit={handleSubmit}>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div className="space-y-1">
              <label htmlFor="name" className="block text-xs sm:text-sm font-mono text-zinc-500">
                Name
              </label>
              <input
                id="name"
                ...
                className="w-full px-3 py-2 rounded-lg text-sm sm:text-base bg-transparent border border-zinc-200 dark:border-zinc-800 text-zinc-900 dark:text-zinc-100 placeholder-zinc-400 focus:outline-none focus:border-zinc-500 transition-colors"
              />
            </div>

            <div className="space-y-1">
              <label htmlFor="email" className="block text-xs sm:text-sm font-mono text-zinc-500">
                Email
              </label>
              <input
                id="email"
          ...
          <div className="space-y-1">
            <label htmlFor="message" className="block text-xs sm:text-sm font-mono text-zinc-500">
              Message
            </label>
            <textarea
              id="message"
              ...
              className="w-full px-3 py-2 rounded-lg text-sm sm:text-base bg-transparent border border-zinc-200 dark:border-zinc-800 text-zinc-900 dark:text-zinc-100 placeholder-zinc-400 focus:outline-none focus:border-zinc-500 transition-colors resize-none"
            />
          </div>

          {status.message && (
            <div
              className={`p-2.5 rounded text-xs sm:text-sm ${
                status.type === "success"
          ...
          <button
            ...
            className="px-4 py-2 rounded-lg text-xs sm:text-sm font-medium bg-zinc-900 text-zinc-50 hover:bg-zinc-800 dark:bg-zinc-100 dark:text-zinc-900 dark:hover:bg-zinc-200 transition-all duration-150 active:scale-95 disabled:opacity-40 disabled:cursor-not-allowed cursor-pointer"
          >
