    ...
    return (
        <div className="flex items-center justify-center min-h-screen bg-zinc-100 dark:bg-zinc-950 transition-colors duration-500">
            <div className="text-center flex flex-col items-center justify-center space-y-4 px-4">
                ...
                <Link to="/blog" className="p-2 text-indigo-800 dark:text-indigo-400 bg-zinc-50 dark:bg-zinc-900 m-2 flex text-lg w-40 text-center items-center justify-center hover:bg-zinc-300 dark:hover:bg-zinc-950 transition-all ease-in-out duration-200 font-bold rounded border dark:border-zinc-700 border-zinc-50">
