  ...
  return (
    <header className="flex items-center justify-between py-2 mb-10 text-sm text-zinc-600 dark:text-zinc-400">
      ...
      <div className="flex items-center gap-1.5 min-w-0">
        <Link
          to="/"
          className="font-medium text-zinc-900 dark:text-zinc-100 px-1.5 py-0.5 -ml-1.5 rounded hover:bg-zinc-100 dark:hover:bg-zinc-900 transition-colors"
        >
          Yahya
        </Link>
        {subpage && (
      ...
      <nav className="flex items-center gap-1 sm:gap-2">
        ...
        <button
          onClick={toggleTheme}
          className="p-1.5 ml-1 rounded text-zinc-400 hover:text-zinc-900 dark:hover:text-zinc-100 hover:bg-zinc-100 dark:hover:bg-zinc-900 transition-colors"
