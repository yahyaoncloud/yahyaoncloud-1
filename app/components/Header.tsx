        ...
        <div className="flex items-center justify-between ">
          ...
          <Link to="/admin/home" className="flex items-center space-x-2 group">
            ...
            <span
              ...
              } transition-all ease-in-out mrs-saint-delafield-regular lacquer-regular font-thin  text-gray-900 dark:text-white group-hover:text-navy-600 dark:group-hover:text-copper-400 duration-400`}
            >
              Yahya On Cloud
            </span>
          </Link>
