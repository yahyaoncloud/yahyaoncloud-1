...
export default function Footer() {
  ...
  return (
    <footer className="w-full border-t border-zinc-200 dark:border-zinc-800 pt-6 mt-16 text-xs text-zinc-500 dark:text-zinc-500 flex items-center justify-between">
      <div>
