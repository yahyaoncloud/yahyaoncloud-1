  ...
  return json({
    ...
    ENV: {
      ...
      FIREBASE_CONFIG: {
        ...
        authDomain: process.env.FIREBASE_AUTH_DOMAIN || process.env.VITE_PUBLIC_FIREBASE_AUTH_DOMAIN,
        databaseURL: process.env.FIREBASE_DATABASE_URL || process.env.VITE_PUBLIC_FIREBASE_DATABASE_URL,
        projectId: process.env.FIREBASE_PROJECT_ID || process.env.VITE_PUBLIC_FIREBASE_PROJECT_ID,
        storageBucket: process.env.FIREBASE_STORAGE_BUCKET || process.env.VITE_PUBLIC_FIREBASE_STORAGE_BUCKET,
        messagingSenderId: process.env.FIREBASE_MESSAGING_SENDER_ID || process.env.VITE_PUBLIC_FIREBASE_MESSAGING_SENDER_ID,
        appId: process.env.FIREBASE_APP_ID || process.env.VITE_PUBLIC_FIREBASE_APP_ID,
        measurementId: process.env.MEASUREMENT_ID || process.env.VITE_PUBLIC_MEASUREMENT_ID,
      },
    },
  });
}
