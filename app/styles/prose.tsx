export const proseClasses = `
  ...
  /* Paragraphs */
  prose-p:text-zinc-800 dark:prose-p:text-zinc-200 prose-p:leading-7 prose-p:mb-6 xl:prose-p:text-sm
  ...
  /* Lists */
  prose-ul:pl-6 prose-ul:mb-6 prose-ol:pl-6 prose-ol:mb-6 dark:prose-ul:text-zinc-200 dark:prose-ol:text-zinc-200  xl:prose-ul:text-sm
  prose-li:marker:text-teal-600 dark:prose-li:marker:text-teal-400 prose-li:mb-1 xl:prose-p:text-sm xl:prose-li:text-sm prose-li:prose-p:text-zinc-950 dark:prose-li:prose-p:text-white
  ...
  /* Code blocks */
  prose-pre:bg-zinc-900 dark:prose-pre:bg-zinc-950 prose-pre:rounded-md prose-pre:p-4 xl:prose-pre:text-sm
  prose-pre:overflow-x-auto prose-pre:font-mono prose-pre:text-sm sm:prose-pre:text-base xl:prose-pre:text-sm
  prose-pre:text-emerald-200 dark:prose-pre:text-emerald-300 xl:prose-pre:text-sm
